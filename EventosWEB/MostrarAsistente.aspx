...
<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="row mt-5">
        <asp:GridView ID="grillaAsistente" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" CssClass="table table-hover table-bordered" EmptyDataText="No hay registros" runat="server">
            <Columns>
